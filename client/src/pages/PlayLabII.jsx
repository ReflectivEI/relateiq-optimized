...
export default function PlayLabII() {
  ...
  if (!["romantic", "friendship"].includes(normalizedRelationshipType)) {
    return (
      <div className="space-y-6">
        <section className="rounded-[1.75rem] border border-[#0e6f72]/18 bg-white p-8 shadow-[0_18px_38px_rgba(15,23,42,0.06)]">
          ...
          <p className="mt-4 max-w-3xl text-[16px] leading-7 text-[#4e6077]">
            This session deck is currently available for partner and friendship connections only. Family and other
            relationship types stay hidden here until their own deck logic is ready.
          </p>
          <div className="mt-6 rounded-[1.25rem] border border-[#0e6f72]/14 bg-[#f8fbfb] p-5 text-[15px] leading-7 text-[#4e6077]">
            Use Questionnaire, Analysis Engine, AI Coach, Check-In, and the relationship-type-aware surfaces for this
            connection while I finish the family and other deck split.
          </div>
        </section>
      </div>
    );
