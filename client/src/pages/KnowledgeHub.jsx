...
const RESOURCES = {
  ...
  lgbtq: [
    ...
    {
      title: "Psychology Today — LGBTQ",
      description: "Therapist directory and articles on LGBTQ+ relationships and identity",
  ...
  communication: [
    ...
    {
      title: "MindTools — Communication",
      description: "Practical guides for active listening, feedback, and difficult conversations",
      url: "https://www.mindtools.com/communication-skills",
      category: "Communication + Conflict",
      relevantFrameworks: ["CBT", "GOTTMAN"],
    },
    {
      title: "Harvard Health — Relationships",
      description: "Evidence-based articles on healthy relationships and mental health",
