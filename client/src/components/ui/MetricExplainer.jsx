...
export default function MetricExplainer({
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        {children || (
          <button
            type="button"
            className={cn(
              "inline-flex items-center gap-1.5 rounded-full border border-primary/35 bg-white px-3 py-1.5 text-xs font-semibold text-primary transition-all hover:border-primary hover:bg-[#e8f7f6] hover:shadow-sm",
              triggerClassName
            )}
          >
            {label}
      ...
      <PopoverContent align="end" className="w-[22rem] rounded-2xl border border-primary/20 bg-white p-4 shadow-xl">
        <div className="space-y-3">
          ...
          {calculation && (
            <div className="rounded-2xl border border-border/60 bg-[#eef4fb] p-3">
          ...
          {source && (
            <div className="rounded-2xl border border-border/60 bg-[#f8fbfd] p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {coachingTips.map((tip) => (
                  <div key={tip} className="flex gap-2 rounded-2xl border border-primary/15 bg-[#e8f7f6] p-3 text-sm text-foreground">
